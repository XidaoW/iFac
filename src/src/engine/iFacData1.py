...
class iFacData():
	...
	def readData(self, domain = "nba", columns = []):
		...
		if self.domain in ["nbaplayershot"]:
		...
		elif self.domain in ["biomarker","biomarker_colorectal_age_group","biomarker_colorectal","biomarker_gastric_Age_Gender_type"]:
			...
			patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Group_direction.csv")
			columns = ['age', 'gender', 'type', 'biomarker','value','direction']
			patients.columns = columns
			self.column = columns[:4] + ['direction']
		...
		elif self.domain in ["biomarker_patient"]:
			# patients = pd.read_csv("data/biomarker_gastric_Age_Gender_type.csv")
			# patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Group_abs.csv")
			patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Patient_ID_direction.csv")
			columns = ['age', 'gender', 'patient', 'biomarker','value','direction']
			patients.columns = columns
			self.column = columns[:4] + ['direction']
			patients_group = patients.groupby(self.column)['value'].mean()			
			self.hist, self.labels = self.createDataHistogram(patients_group, self.column)

		elif self.domain in ["biomarker_patient_matrix"]:
			# patients = pd.read_csv("data/biomarker_gastric_Age_Gender_type.csv")
			# patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Group_abs.csv")
			patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Patient_ID_matrix.csv")
			columns = ['age', 'gender', 'patient', 'biomarker','value']
			patients.columns = columns
			self.column = ['patient','biomarker']
			patients_group = patients.groupby(self.column)['value'].mean()
			self.hist, self.labels = self.createDataHistogram(patients_group, self.column)

		elif self.domain in ["minsheng"]:
			# patients = pd.read_csv("data/biomarker_gastric_Age_Gender_type.csv")
			# patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Group_abs.csv")
			patients = pd.read_csv("data/minsheng.csv")
			columns = ['client_device', 'client_frame_version', 'client_name', 'http_status','http_type', 'ip', 'hour']
			patients.columns = columns
			self.column = ['client_device', 'client_frame_version', 'client_name','http_type', 'ip', 'hour','http_status']
			patients_group = patients.groupby(self.column)['http_status'].count()
			self.hist, self.labels = self.createDataHistogram(patients_group, self.column)


		elif self.domain in ["biomarker_patient_gender"]:
			# patients = pd.read_csv("data/biomarker_gastric_Age_Gender_type.csv")
			# patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Group_abs.csv")
			patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Patient_ID_direction.csv")
			columns = ['age', 'gender', 'patient', 'biomarker','value','direction']
			patients.columns = columns
			self.column = columns[1:4] + ['direction']
			patients_group = patients.groupby(self.column)['value'].mean()			
			self.hist, self.labels = self.createDataHistogram(patients_group, self.column)

		elif self.domain in ["biomarker_patient_age"]:
			# patients = pd.read_csv("data/biomarker_gastric_Age_Gender_type.csv")
			# patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Group_abs.csv")
			patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Patient_ID_direction.csv")
			columns = ['age', 'gender', 'patient', 'biomarker','value','direction']
			patients.columns = columns
			self.column = ['patient','age','biomarker','direction']
			patients_group = patients.groupby(self.column)['value'].mean()			
			self.hist, self.labels = self.createDataHistogram(patients_group, self.column)

		elif self.domain in ["biomarker_patient_direction"]:
			# patients = pd.read_csv("data/biomarker_gastric_Age_Gender_type.csv")
			# patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Group_abs.csv")
			patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Patient_ID_direction.csv")
			columns = ['age', 'gender', 'patient', 'biomarker','value','direction']
			patients.columns = columns
			self.column = columns[2:4] + ['direction']
			patients_group = patients.groupby(self.column)['value'].mean()			
			self.hist, self.labels = self.createDataHistogram(patients_group, self.column)



		elif self.domain in ["gastric_biomarker_patient_matrix"]:
			# patients = pd.read_csv("data/biomarker_gastric_Age_Gender_type.csv")
			# patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Group_abs.csv")
			patients = pd.read_csv("data/biomarker_gastric_Age_Gender_Patient_ID_direction_direction.csv")
			# columns = ['age', 'gender', 'patient', 'biomarker','value']
			columns = ['patient', 'age','gender', 'biomarker','value','direction']
			patients.columns = columns
			self.column = ['patient','biomarker']
			patients_group = patients.groupby(self.column)['value'].mean()
			self.hist, self.labels = self.createDataHistogram(patients_group, self.column)
		...
		elif self.domain in ["gastric_biomarker_patient_gender"]:
			# patients = pd.read_csv("data/biomarker_gastric_Age_Gender_type.csv")
			# patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Group_abs.csv")
			patients = pd.read_csv("data/biomarker_gastric_Age_Gender_Patient_ID_direction_direction.csv")
			columns = ['patient', 'age','gender', 'biomarker','value','direction']
			patients.columns = columns
			self.column = ['gender','patient','biomarker'] + ['direction']
			patients_group = patients.groupby(self.column)['value'].mean()			
			self.hist, self.labels = self.createDataHistogram(patients_group, self.column)

		elif self.domain in ["gastric_biomarker_patient_age"]:
			# patients = pd.read_csv("data/biomarker_gastric_Age_Gender_type.csv")
			# patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Group_abs.csv")
			patients = pd.read_csv("data/biomarker_gastric_Age_Gender_Patient_ID_direction_direction.csv")
			columns = ['patient', 'age','gender', 'biomarker','value','direction']
		...
		elif self.domain in ["gastric_biomarker_patient_direction"]:
			# patients = pd.read_csv("data/biomarker_gastric_Age_Gender_type.csv")
			# patients = pd.read_csv("data/biomarker_colorectal_healthy_Age_Gender_Group_abs.csv")
			patients = pd.read_csv("data/biomarker_gastric_Age_Gender_Patient_ID_direction_direction.csv")
			columns = ['patient', 'age','gender', 'biomarker','value','direction']
			patients.columns = columns
			self.column = ['patient','biomarker','value'] + ['direction']
			patients_group = patients.groupby(self.column)['value'].mean()			
			self.hist, self.labels = self.createDataHistogram(patients_group, self.column)
